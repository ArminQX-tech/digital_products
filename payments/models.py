...
class Gateway(models.Model):
    title=models.CharField(_('title'),max_length=46)
...
class Payment(models.Model):
    ...
    token = models.CharField(_('token'), max_length=255, blank=True)   
    phone_number = models.CharField(_('phone number'), max_length=15, validators=[validate_phone_number], db_index=True)     
